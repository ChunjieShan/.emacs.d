...
(use-package swiper
  ...
  (("<leader>ss" . swiper)
   ("<leader>sr" . swiper)
   ("<leader>cr" . ivy-resume)
   ("M-x" . counsel-M-x)
   ("<leader>ff" . counsel-find-file))
  :config
  (progn
    (ivy-mode 1)
...
(use-package counsel
  ...
  :ensure t
  :bind
  (("<leader>fr" . 'counsel-recentf) 
   ("<leader>fj" . 'counsel-dired))
  :config
...
(use-package avy 
  :ensure t
  :bind (("<leader> :" . 'avy-goto-char)
         ("<leader> '" . 'avy-goto-char-2)
         ("<leader> \"" . 'avy-goto-char-timer)
         ("<leader> fl" . 'avy-goto-line)
         ("<leader> wo" . 'avy-goto-word-1)
         ("<leader> e" . 'avy-goto-word-0)))
